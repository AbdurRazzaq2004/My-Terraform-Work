#!/bin/bash
# ========================================
# User Data Script for VMSS Instances
# ========================================
# This script runs on each VM when it boots
# It installs Apache, PHP, and creates a status page
...
# Fetch Azure instance metadata and display it on the page
