...
<img src="https://img.shields.io/badge/Mini_Projects-1-orange?style=flat-square" alt="Projects"/>
...
```
  ...
  │                     FUNDAMENTALS                                │
  │                                                                 │
  │  1. Resource Group & Storage ──► 2. StateFile Management        │
  │            │                                                    │
  │            ▼                                                    │
  │  3. Modular File Structure ────► 4. Variable Type Constraints   │
  └─────────────────────────────────────────────────────────────────┘
                          │
                          ▼
  ┌─────────────────────────────────────────────────────────────────┐
  │                   INTERMEDIATE                                  │
  │                                                                 │
  │  5. Resource Meta Arguments ───► 6. Lifecycle Rules             │
  │            │                                                    │
  │            ▼                                                    │
  │  7. Terraform Expressions ────► 8. Terraform Functions          │
  │                                       │                         │
  │                                       ▼                         │
  │                               9. Data Sources                   │
  └─────────────────────────────────────────────────────────────────┘
  ...
  │                 MINI PROJECTS                                   │
  │                                                                 │
  │  🚀 Project 1: Scalable Web App (VMSS + LB + Autoscaling)      │
  │                                                                 │
